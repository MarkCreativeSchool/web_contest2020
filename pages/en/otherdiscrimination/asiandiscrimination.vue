...
<br />
    ...
    <div class="nextback">
            <nuxt-link to="/en/otherdiscrimination/genderdiscrimination"><img class="back" :src="`${prefix}/back2.png`"></nuxt-link>
            <nuxt-link to="/en/otherdiscrimination/sexualorientationdiscrimination"><img class="next" :src="`${prefix}/next.png`"></nuxt-link>
        </div>
     <Footereng></Footereng>
  </div>
</template>
