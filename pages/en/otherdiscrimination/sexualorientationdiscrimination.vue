  ...
  <Headereng></Headereng>
   <div class="info">
    ...
    <p class="two_sexualorientation">
       Sexual orientation discrimination is <mark class="highlights"><b>discrimination against one’s sexuality</b></mark>.
    ...
    <div class="nextback">
            <nuxt-link to="/en/otherdiscrimination/asiandiscrimination"><img class="back" :src="`${prefix}/back2.png`"></nuxt-link>
            <nuxt-link to="/en/otherdiscrimination/religiousdiscrimination"><img class="next" :src="`${prefix}/next.png`"></nuxt-link>
        </div>
...
export default {
  ...
  head() {
    return {
      title: "Sexual Orientation-Introducing Racism for High School Students by High School Students-高校生による高校生のため黒人差別",
      meta: [
        { hid: "description", name: "description", content: "A brief introduction of discrimination based on their sexual orientation and some events/incidents that have occurred are explained." }
      ]
    }
  },
}　
