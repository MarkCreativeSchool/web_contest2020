<template>
  <div>
    ...
    <div class="event-modal">
      <div class="event-title">Chapter 6: World War II</div>
      <!--イベント-->
      ...
      <div class="year">
          <h6>
            <div class="timelineFirst">1939</div>
          </h6>
          <h6>
            <div class="timelineLast">1944</div>
          </h6>
      </div>
    </div>
...
import event1 from "~/components/events_eng/6th/event1"
import event2 from "~/components/events_eng/6th/event2"
import event3 from "~/components/events_eng/6th/event3"
import event4 from "~/components/events_eng/6th/event4"
