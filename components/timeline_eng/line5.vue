<template>
  <div>
      ...
      <div class="event-modal">
        <div class="event-title">Chapter 5: World War I</div>
        <!--イベント-->
        ...
        <div class="year">
          <h6>
            <div class="timelineFirst">1914</div>
          </h6>
          <h6>
            <div class="timelineLast">1918</div>
          </h6>
        </div>
      </div>
...
<script>
import event1 from "~/components/events_eng/5th/event1"
import event2 from "~/components/events_eng/5th/event2"
import event3 from "~/components/events_eng/5th/event3"
import event4 from "~/components/events_eng/5th/event4"
import event5 from "~/components/events_eng/5th/event5"
