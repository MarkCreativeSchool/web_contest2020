<template>
  <div>
    ...
    <div class="event-modal">
      <div class="event-title">History of Racism</div>
      <!--イベント-->
      ...
      <div class="year">
          ...
          <h6>
            <div class="timelineLast">1963</div>
          </h6>
      </div>
    </div>
...
<script>
import event1 from "~/components/events_eng/lastLine/event1"
import event2 from "~/components/events_eng/lastLine/event2"
import event3 from "~/components/events_eng/lastLine/event3"
import event4 from "~/components/events_eng/lastLine/event4"
import event5 from "~/components/events_eng/lastLine/event5"
